 ...
 * @author krate
 */
public class AsignacionAmarreDTO {
    ...
    public AsignacionAmarreDTO() {
    }
    
    public AsignacionAmarreDTO(Long id_asignacion, String matricula_yate, Long num_amarre, LocalDateTime fecha_inicio, LocalDateTime fecha_fin, double monto, String usuario_solicitante_cedula, String tipo_asignacion) {
